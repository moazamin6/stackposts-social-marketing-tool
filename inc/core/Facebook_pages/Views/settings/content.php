<div class="card card-flush m-b-25">
    ...
    <div class="card-body">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control form-control-solid" id="facebook_page_permissions" name="facebook_page_permissions" value="<?php _e( get_option("facebook_page_permissions", "pages_read_engagement,pages_manage_posts,pages_show_list") )?>">
        </div>
